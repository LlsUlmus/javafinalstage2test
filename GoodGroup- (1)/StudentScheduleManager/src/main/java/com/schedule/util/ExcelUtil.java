...
public class ExcelUtil {
     ...
     * 从 Excel 文件导入课程数据
     */
    public static List<Course> importCoursesFromExcel(String filePath, int userId) {
        ...
        try (FileInputStream fis = new FileInputStream(new File(filePath));
            ...
            for (Row row : sheet) {
                ...
                Course course = createCourseFromExcelData(userId, name, teacher, location,
    ...
    private static Course createCourseFromExcelData(int userId, String name, String teacher, String location,
                                                    String dayOfWeekStr, String startTimeStr, String endTimeStr, String typeStr, String description) {
        ...
        if (dayOfWeek == null || startTime == null || endTime == null || type == null) {
            return null;
        }
        ...
        course.setReminderEnabled(true);

        return course;
    }

    private static DayOfWeek parseDayOfWeek(String dayOfWeekStr) {
    ...
    private static Course.CourseType parseCourseType(String typeStr) {
        try {
            return Course.CourseType.valueOf(typeStr);
        } catch (Exception e) {
            return null;
        }
    }
